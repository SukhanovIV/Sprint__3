...
class TestRegistration():
    ...
    def test_successful_registration_with_correct_username_and_password(self, ):
        driver = webdriver.Chrome()
        Locators.correct_registration()
        correct_login()
        clicking_button_personal_account()
        assert WebDriverWait(driver, 1).until(expected_conditions.visibility_of_element_located((clicking_button_profile())))
        driver.quit()
